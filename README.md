...
| # | Project | Skills |
|---|---|---|
| 8 | [Signature Detection & Verification](../Signature-Detection-Verification) | PyTorch · CNN · OpenCV |
| 10 | [Prodigy ML Internship](../Prodigy-ML-Internship) | Scikit-learn · TensorFlow · K-Means |
| **14** | **Arabic Text Summarization ← You are here** | **Python · NLTK · Gensim · Word2Vec · NLP** |
| 13 | [Competitor Price Scraper](../Competitor-Price-Scraper) | Python · BeautifulSoup4 · Requests |
